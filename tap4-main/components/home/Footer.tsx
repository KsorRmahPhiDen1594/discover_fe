    ...
    <>
      <footer className="w-full bg-black">
            ...
            <div className="flex flex-col items-center gap-1 lg:items-start">
              ...
              <ul className="flex flex-col items-center gap-3 lg:items-start">
                ...
                <li>
                  <div
                    title="Submit AI"
                    className="flex items-center gap-1 text-nowrap text-xs hover:opacity-70 lg:text-sm cursor-pointer"
                ...
                <li>
                  <Link href="/">
                    ...
                    >
                      ...
                      >
                        <path d="M21 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h6" />
                        <path d="m21 3-9 9" />
                        <path d="M15 3h6v6" />
                      </svg>
                    </div>
        ...
        <div className="mx-auto grid w-full max-w-pc grid-cols-3 items-center justify-center gap-5 p-5 lg:flex lg:h-16 lg:p-0">
          <a lang="en" className="hover:underline" href="/">English</a>
          <a lang="ja" className="hover:underline" href="/">日本語</a>
          <a lang="pt" className="hover:underline" href="/">Português</a>
          <a lang="es" className="hover:underline" href="/">Español</a>
          <a lang="de" className="hover:underline" href="/">Deutsch</a>
          <a lang="ru" className="hover:underline" href="/">Русский</a>
          <a lang="fr" className="hover:underline" href="/">Français</a>
          <a lang="cn" className="hover:underline" href="/">简体中文</a>
          <a lang="tw" className="hover:underline" href="/">繁體中文</a>
          <a lang="ko" className="hover:underline" href="/">한국어</a>
          <a lang="th" className="hover:underline" href="/">ไทย</a>
          <a lang="vi" className="hover:underline" href="/">Tiếng Việt</a>
        </div>
      </footer>
      <LoginModal
